...
class EventService: NSObject {
    ...
    func createEvent(_ name: String, type: String, city: String, place: String, startTime: Date, endTime: Date, max_players: UInt, info: String?, completion:@escaping (Event?, NSError?) -> Void) {
        ...
        var params: [String: Any] = ["name": name, "type": type, "city": city, "place": place, "startTime": startTime.timeIntervalSince1970, "endTime": endTime.timeIntervalSince1970, "max_players": max_players, "owner": user.uid]
...
extension Event {
    ...
    func randomType() -> String {
        let types: [EventType] = [.futbol, .basketball, .flagFootball]
